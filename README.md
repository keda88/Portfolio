...
| [Исследовательская работа для сервиса “Мой Чемпион”](Taxi) | Прогнозирование выполнения спортсменами элементов фигурного катания на основе результатов предыдущих соревнований| *python pandas  MultiOutputClassifier Scikit-Learn  catboost* |
